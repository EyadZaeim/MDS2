...
Qq = input ('Please enter full sheet name :')
# Fill-in IDs of your Docs template & any Sheets data source
DOCS_FILE_ID = '11Q1Q57MQMP-XJr6T1PRf63ZIdcp9RH2l_TOpJDzTBfw'
SHEETS_FILE_ID = '1zTZRO27k_f5YsX9zkUXjsmuHsGvYdjDntUk0cJHLDog'
...
result = service.documents().batchUpdate(documentId= '1pvE_0M19RBrbe-VSyAFULENd7IndWPe4CUjRpp5Fd24 ', body={'requests': requests}).execute()
